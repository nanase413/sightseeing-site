...
const HamburgerMenuAboutAmerica = () => {
      ...
      {isOpen && (
        <Menu>     
          <LinkArea>
            ...
            <LinkStyle>
              <LinkFont to="/america/details/americaFood" className="menu-food" >
                FOOD
              </LinkFont>
            </LinkStyle>
            <LinkStyle>
              <LinkFont to="/america/details/americaSpot" className="menu-spot" >
                SPOT
              </LinkFont>
            </LinkStyle>
          </LinkArea>
...
export default HamburgerMenuAboutAmerica;