...
const HamburgerMenuAboutGermany = () => {
      ...
      {isOpen && (
        <Menu>     
          <LinkArea>
            ...
            <LinkStyle>
              <LinkFont to="/germany/details/germanyFood" className="menu-food" >
                FOOD
              </LinkFont>
            </LinkStyle>
            <LinkStyle>
              <LinkFont to="/germany/details/germanySpot" className="menu-spot" >
                SPOT
              </LinkFont>
            </LinkStyle>
          </LinkArea>
...
export default HamburgerMenuAboutGermany;