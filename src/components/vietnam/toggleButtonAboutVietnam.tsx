...
const HamburgerMenuAboutVietnam = () => {
    ...
    <div>
      ...
      {isOpen && (
        <Menu>     
          <LinkArea>
            <LinkStyle>
              <LinkFont to="/germany" className="menu-germany">
                GERMANY
              </LinkFont>
            </LinkStyle>
            <LinkStyle>
            ...
            <LinkStyle>
              <LinkFont to="/vietnam/details/vietnamFood" className="menu-food" >
                FOOD
              </LinkFont>
            </LinkStyle>
            <LinkStyle>
              <LinkFont to="/vietnam/details/vietnamSpot" className="menu-spot" >
                SPOT
              </LinkFont>
            </LinkStyle>
          </LinkArea>
...
export default HamburgerMenuAboutVietnam;